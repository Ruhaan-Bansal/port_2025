...
class GameLevelJungle {
  constructor(path) {
    ...
    const sprite_data_chillguy = {
        id: 'player', // Changed to "player" to match the collision detection in Enemy.js
    ...
    const sprite_data_panda = {
      ...
      const sprite_data_elephant = {
          ...
          hitbox: { widthPercentage: 0.1, heightPercentage: 0.2 },
          speed: 3, // Initial speed for the enemy
          immune: 0 // Immunity status
      };
    ...
    this.objects = [
      ...
      { class: Enemy, data: sprite_data_elephant }, // Changed from Npc to Enemy
